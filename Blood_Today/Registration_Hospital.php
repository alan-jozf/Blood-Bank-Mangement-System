...
<body>
	...
	<form action="php\addHospital.php" method="POST" >
	<h1> <center>Add a Hospital</center></h1>

	<input type="text" placeholder="Name of Hospital :" name="name" id="0"  onblur="myname()" required>
